...
GLfloat speed15 = 0.04f;
//CAR 5
GLfloat position16 = 0.0f;
GLfloat speed16 = 0.025f;
...
void update2(int value) {
    ...
    if(position2 < -1.20)//starting point
        position2 = .99f;
